...
![Salary Distributions of Data jobs in the US](3_Project\Images\salary_distribution.png) *Box plot visualizing the salary distributions for the top 6 data job titles.*
